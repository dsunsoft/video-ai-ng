...
export class SysUserService {
    ...
    private resourceRoleUrl = `${API_URL}/video-ai/sysRole`;
     ...
     */
    save(SysUser: any): Observable<any> {
        return this.http.post(`${this.resourceUrl}/save`, SysUser);
    }
    ...
    getRoleList(req?: any): Observable<any> {
        return this.http.post(`${this.resourceRoleUrl}/page`, req);
    }
