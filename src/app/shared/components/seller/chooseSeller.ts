...
@Component({
  selector: 'app-shared-chooseSeller',
  styles: [`
  .active {
    background: #1890FF;
    color: #fff;
  ...
  `],
  templateUrl: './chooseSeller.html',
})
export class ChooseSellerComponent implements OnInit, OnDestroy {
  query: any = {
    pageIndex: 1,
    pageSize: 10,
    total: 0,
  ...
  st: STComponent;
  columns: STColumn[] = [
    { title: '选择', index: 'sellerId', type: 'radio',width:'5%' },
    {
